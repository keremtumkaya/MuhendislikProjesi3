...
function LogicSim()
{
	...
	this.initialize = function()
	{
		...
		var grp = this.toolbar.addGroup("SÝL");
		...
		grp = this.toolbar.addGroup("GÝRÝÞ");
		grp.addItem(new ConstInput());
		

		grp = this.toolbar.addGroup("ÇIKIÞ");
	...
	this.mainLoop = function(self)
	{
		...
		if (myIsDragging) {
            ...
            mySelection.render(self.context, pos, myCanPlace ? "#FF0000" : "#FF0000");
		} else if (myIsWiring) {		
